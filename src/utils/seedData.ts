...
export const getSeedData = () => {
  ...
  // Initial Balances
  addTx(60, 'income', 4500, 'Opening Balance', 'cat_5', 'acc_1');
  addTx(60, 'income', 10000, 'Opening Balance', 'cat_5', 'acc_3');
  addTx(60, 'income', 150, 'Cash on hand', 'cat_6', 'acc_4');

  // Monthly Recurring
  [55, 25].forEach(days => {
      addTx(days, 'income', 4200, 'Salary Deposit', 'cat_5', 'acc_1');
      addTx(days - 2, 'expense', 1800, 'Monthly Rent', 'cat_4', 'acc_1');
      addTx(days - 3, 'expense', 60, 'Internet Bill', 'cat_4', 'acc_2');
      addTx(days - 1, 'transfer', 500, 'Monthly Savings', 'cat_transfer', 'acc_1', 'acc_3');
  });

  // Random Spending
  const expenseMix = [
      { cat: 'cat_1', desc: 'Whole Foods Market', min: 80, max: 200, acc: 'acc_2' },
      { cat: 'cat_1', desc: 'Starbucks', min: 6, max: 15, acc: 'acc_2' }, 
      { cat: 'cat_1', desc: 'Local Diner', min: 30, max: 60, acc: 'acc_1' },
      { cat: 'cat_2', desc: 'Uber Ride', min: 15, max: 40, acc: 'acc_2' },
      { cat: 'cat_2', desc: 'Shell Gas Station', min: 40, max: 70, acc: 'acc_2' },
      { cat: 'cat_7', desc: 'Netflix Subscription', min: 15, max: 15, acc: 'acc_2' },
      { cat: 'cat_7', desc: 'Cinema Tickets', min: 30, max: 50, acc: 'acc_2' },
      { cat: 'cat_3', desc: 'Amazon Purchase', min: 20, max: 150, acc: 'acc_2' },
  ...
  const budgets: Budget[] = [
      { id: 'bud_1', category_id: 'cat_1', limit_amount: 800, period: 'monthly' },
      { id: 'bud_2', category_id: 'cat_3', limit_amount: 400, period: 'monthly' },
      { id: 'bud_3', category_id: 'cat_2', limit_amount: 300, period: 'monthly' },
      { id: 'bud_4', category_id: 'cat_7', limit_amount: 200, period: 'monthly' },
  ];
