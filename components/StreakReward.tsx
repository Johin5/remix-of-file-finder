...
import { Flame, Check, Share2, X } from 'lucide-react';
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="mb-6 relative">
                    ...
                    <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-orange-500 to-red-600 flex items-center justify-center shadow-lg shadow-orange-500/40 relative animate-[bounce_2s_infinite]">
                ...
                <div className="flex flex-col gap-3 w-full">
                    ...
                    <button 
                        onClick={handleClose} // In real app, share logic
